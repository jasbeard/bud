...
const organizationData = {
  ...
  name: "Bud",
  url: "https://bud.app",
  logo: "https://bud.app/logo.png",
  description:
    "Budget tracking and financial analytics platform to help you master your finances.",
  sameAs: [],
};
...
const websiteData = {
  ...
  potentialAction: {
    ...
    target: {
      "@type": "EntryPoint",
      urlTemplate: "https://bud.app/search?q={search_term_string}",
    },
    "query-input": "required name=search_term_string",
  },
};

// Metadata for this page (server-side)
...
export default function Home() {
  return (
    <>
      {/* Structured Data for SEO - JSON-LD in head */}
      <script
      ...
      <div className="min-h-screen bg-background">
        ...
        <main role="main">
          ...
          >
            <div className="container mx-auto px-4 py-24 md:py-32">
              <div className="mx-auto max-w-4xl text-center">
                <LandingBadge className="mb-6" variant="secondary">
                  Budget Analytics
                </LandingBadge>
                <h1
                  id="hero-heading"
                ...
                <p className="mb-8 text-xl text-muted-foreground md:text-2xl">
                  From first transaction to financial goals, understand exactly
                  how your spending drives your financial future with powerful
                  budget analytics.
                </p>
                <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                  <Button size="lg" className="w-full sm:w-auto" asChild>
                    <Link href="/signup" aria-label="Start using Bud for free">
                      Start for free
          ...
          <section
            className="border-b bg-muted/30 py-24"
                ...
                <Card className="overflow-hidden">
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <LandingBadge variant="secondary">Live</LandingBadge>
                    </div>
                  </CardHeader>
                  <CardContent>
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Set up custom budget periods that match your pay
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Deep dive into spending patterns with detailed
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        ...
                        or when unusual spending patterns are detected.
                      </CardDescription>
                    </CardHeader>
                  </Card>
                </div>
            ...
            <div className="container mx-auto px-4">
              <div className="mx-auto max-w-6xl">
                <div className="mb-12 text-center">
                  ...
                  <p className="text-lg text-muted-foreground">
                    Gain deeper insights with fine-grained, transaction-level
                    data. Understand every expense in real-time.
                  </p>
                </div>
                ...
                <Card>
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <LandingBadge variant="secondary">
